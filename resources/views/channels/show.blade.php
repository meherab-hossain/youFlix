                        ...
                        <form id="update-channel-form" action="{{route('channels.update',$channel->id)}}" method="POST"
                            ...
                            @if($channel->editable())
                                <input onchange="document.getElementById('update-channel-form').submit()"
                                       style="display: none" type="file" id="image" name="image">
                                <span class="text-danger font-weight-bold d-inline-block"> {{$errors->has('image') ? $errors->first('image'):''}} </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" name="name" value="{{$channel->name}}"
                                           class="form-control">
                                </div>
                                ...
                                <span class="text-danger font-weight-bold"> {{$errors->has('description') ? $errors->first('description'):''}} </span>

                                <button type="submit" class="btn-info d-block">
                                    update channel
                                </button>
                            @endif
                        </form>
